...
def read_tags_of_a_resource(dataObject):
    ...
    try:
        ...
        req = models.DescribeResourceTagsRequest()
        params = {
            "ResourceId": dataObject['Id']
        }
        req.from_json_string(json.dumps(params))

        # 返回的resp是一个DescribeResourceTagsResponse的实例，与请求对象对应
        resp = client.DescribeResourceTags(req)
        # 输出json格式的字符串回包
